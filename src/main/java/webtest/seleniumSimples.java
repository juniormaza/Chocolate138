...
public class seleniumSimples {
    ...
    @BeforeMethod
    public void setUp(){
        // Intalar e configurar o driver do navegador/browser
        WebDriverManager.chromedriver().setup(); // douwnload e instalação do Chrome Driver

        // Configurar as opções para o driver do navegador (a partir do Selenium 4.8.0)
        ChromeOptions options = new ChromeOptions(); // objeto de configuração para Chrome Driver
        ...
        driver = new ChromeDriver(options); // Instancia o Selenium para Chrome Driver com opções
        // Configura o tempo geral de espera de elementos em ate 5 segundos
        driver.manage().timeouts().implicitlyWait(Duration.ofMillis(5000));
        driver.manage().window().maximize(); // mazimiza a janela do navegador
    ...
    public void testarSelectBackdrop(){
        ...
        // Trancição de página / Carregamento de nova página (lentidão)
        ...
        // Verifica se está presente o elemento do carrinho
        assertTrue(driver.findElement(By.id("shopping_cart_container")).isDisplayed());

        // Selecionar o produto que seria o id n° 4
